...
<html lang="<?php echo substr(get_locale(), 0, 2); ?>">
  <head>
    ...
    <?php
        if (defined('SIMPLY_HEADER')) {
            if (!isset($class)) {
                $class = '';
            }
            $class .= ' body-fixed-nav ';
        }
    ?>
            ...
            <div class="navigation-container">
                <div class="navigation-header">
                    ...
                    <div class="navigation-controls">
                        <button class="navigation-toggle-button" type="button" data-toggle="collapse" data-target="#navigationMenu" aria-expanded="false">
                            <span class="navigation-hamburger-icon"></span>
                            Menu
                        </button>
                    </div>
                </div>
                <div class="navigation-menu collapse" id="navigationMenu">
                    <?php wp_nav_menu(['menu' => 'Main', 'container'=> 'ul']); ?>
                </div>
            </div>
        </div>
    </div>
