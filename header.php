            ...
            <form action="/" method="get">
                <fieldset>
                    <div class="input-group">
                        <input type="text" name="s" class="form-control" value="<?php the_search_query(); ?>" placeholder="Zadejte hledaný text" />
