...
function shp_add_favicon(){ ?>
    <!-- Custom Favicons -->
    <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/scaffolding/img/favicon.ico"/>
    <link rel="apple-touch-icon" href="<?php echo get_template_directory_uri(); ?>/scaffolding/img/apple-touch-icon.png">
<?php }
